...
class Config:
    ...
    FIRESTORE_DB_NAME = get_value_from_env("FIRESTORE_DB_NAME", "ons-sds-sandbox-01")
    ...
    SCHEMA_BUCKET_NAME = get_value_from_env("SCHEMA_BUCKET_NAME", "ons-sds-sandbox-01-schema")
    AUTODELETE_DATASET_BUCKET_FILE = get_value_from_env("AUTODELETE_DATASET_BUCKET_FILE", "True")
    PUBLISH_SCHEMA_TOPIC_ID = get_value_from_env("PUBLISH_SCHEMA_TOPIC_ID", "ons-sds-sandbox-01-publish-schema")
    ...
    SDS_APPLICATION_VERSION = get_value_from_env("SDS_APPLICATION_VERSION", "v1")
